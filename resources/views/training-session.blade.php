...
@section('content')
    ...
    <div class="tab-header">
        <div class="tabs">
            <div class="tab active" onclick="switchTab(event, 'all')">All Session</div>
            <div class="tab" onclick="switchTab(event, 'ongoing')">Active Sessions</div>
            <div class="tab" onclick="switchTab(event, 'completed')">Completed Sessions</div>
